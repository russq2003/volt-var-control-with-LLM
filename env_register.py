...
_ENV_INFO = {
    '13Bus': {
        'system_name': '13Bus',
        'dss_file': 'IEEE13Nodeckt_PVdaily.dss',
        'reg_act_num': 33,
        'bat_act_num': 33,
        'max_PV_Q': 1000,
        'power_w': 10.0,
        ...
        'dis_w': 6.0 / 33,
        'time_interval_ori': 1,
        'time_interval_use': 5  # robert: change here, remember to delete old loadshape folders(000, 001, 002, ....)
    },
...
#         'bat_act_num': 33,
    ...
    #  below envs are writen by robert
    '34Bus_12max_steps': {
        'system_name': '34Bus',
        'dss_file': 'ieee34Mod1_daily.dss',
    ...
    '13Bus_288max_steps': {  # robert: interval equal to 5min
        'system_name': '13Bus',
        'dss_file': 'IEEE13Nodeckt_daily.dss',
...
def make_env(args, env_name, dss_act=False, worker_idx=1):
    # print(worker_idx)
    base_info, folder_path = get_info_and_folder(env_name)

    if worker_idx is None:
        return Env(args, folder_path, base_info, dss_act)
    else:
        ...
        return Env(args, folder_path, info, dss_act)
